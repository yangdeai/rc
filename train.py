...
def train(lr=1e-1):
    ...
    for epoch in range(MAX_EPOCH):
        ...
        with torch.set_grad_enabled(True):
            ...
            logging.info('Loss: {:.4f}[{}] Acc: {:.4f}'.format(train_loss, epoch_count, train_acc))
...
if __name__ == '__main__':
    ...
    best_weight_dir = weight_dir + f'/resnet_{exp_name}_MAX_EPOCH{MAX_EPOCH}'
    save_dir = weight_dir + f'/resnet_{exp_name}_MAX_EPOCH{MAX_EPOCH}.pth'
