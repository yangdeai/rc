...
from deprecated_utils import get_network, RcProjectPre
...
def train(model=None, loss_fn=None, optimizer=None, lr=1e-1, device=None):
    ...
    for epoch in range(MAX_EPOCH):
        ...
        logging.info("\n\n")
        logging.info(f"train_rc.Win: {rcPro_train.Win}, test_rc.Win: {rcPro_test.Win}, epoch{epoch}/{MAX_EPOCH}")
        logging.info("\n\n")
...
if __name__ == '__main__':
    ...
    rc_out_channel = 3 * rcPro_train.resSize
    feature_map = 64
    ...
    # file/dir
    exp_name = f'out_{args.network}_exp{args.exp_num}_res{rcPro_train.resSize}' \
    ...
    # train/test Win
    logging.info("\n\n")
    logging.info(f"train_rc.Win: {rcPro_train.Win}, test_rc.Win: {rcPro_test.Win}")
    logging.info("\n\n")
